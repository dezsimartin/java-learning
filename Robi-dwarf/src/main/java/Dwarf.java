...
public class Dwarf implements Comparable<Dwarf>{
    ...
    public Dwarf(String name){
        this(name, new Random().nextInt(99), new Random().nextInt(120),  true);
    }
...
//        return 1;
    ...
    public int compareTo(Dwarf o) {
        if(o == null) return 1;
        if(o.getTall() > this.tall){return -1;}
        else if(o.getTall() == this.tall){ return 0;}
        return 1;
    }
}
