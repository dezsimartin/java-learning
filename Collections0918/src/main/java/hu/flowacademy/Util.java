...
public class Util {
    ...
    public static void drawMultipleDiagram(double[][] data1, double[][] data2){
        ...
        ds1.addSeries("egy", data1);
        ds2.addSeries("ketto", data2);

        JFreeChart barChart1 =
                ChartFactory.createXYLineChart("Histogram1","", "", ds1,
                        PlotOrientation.VERTICAL, true, true, false);

        frame.getContentPane().add(new ChartPanel(barChart1), BorderLayout.NORTH);

        JFreeChart barChart2 =
                ChartFactory.createXYLineChart("Histogram2","", "", ds2,
                        PlotOrientation.VERTICAL, true, true, false);

        frame.getContentPane().add(new ChartPanel(barChart2), BorderLayout.NORTH);
        frame.pack();
